# -*- coding: utf-8 -*-
"""Part III data: real-life vocabulary, organized around Jenna's actual life
...
THEMES = [
{
  ...
  "dialogue": [
    ("Jenna", "¿Vamos a la playa? Hace sol.", "Shall we go to the beach? It's sunny."),
    ("Novio", "¡Dale! Llevo las toallas y la sombrilla.", "Sure! I'll bring the towels and the umbrella."),
    ("Jenna", "Yo llevo la crema solar y el agua.", "I'll bring the sunscreen and the water."),
    ("Novio", "El mar está tranquilo hoy, perfecto para nadar.", "The sea is calm today, perfect for swimming."),
    ("Jenna", "Quiero ver el atardecer también.", "I want to watch the sunset too."),
  ],
  "story": {
    "title": "Un día en la playa",
    "es": "Es sábado por la mañana y hace sol. Jenna y su novio van a la playa "
          "temprano. El mar está tranquilo y la arena está caliente. Jenna nada "
          ...
          "naranja. “Qué bonito”, dice Jenna.",
    "en": "It's Saturday morning and it's sunny. Jenna and her boyfriend go to "
          "the beach early. The sea is calm and the sand is hot. Jenna swims a "
          ...
          "The sky is pink and orange. “How beautiful,” says Jenna.",
  },
  "fill": [
...
},
{
  ...
  "dialogue": [
    ("Jenna", "El agua está tranquila. Voy a hacer paddleboard.", "The water is calm. I'm going to paddleboard."),
    ("Novio", "¿Llevas el chaleco salvavidas?", "Are you taking the life vest?"),
    ("Jenna", "Sí, siempre. A veces veo delfines por la mañana.", "Yes, always. Sometimes I see dolphins in the morning."),
    ("Novio", "Ten cuidado con la corriente cerca del manglar.", "Be careful with the current near the mangrove."),
    ("Jenna", "Tranquilo, mantengo el equilibrio muy bien.", "Don't worry, I keep my balance very well."),
  ],
  "story": {
    "title": "El amanecer en la tabla",
    "es": "Jenna se levanta muy temprano, cuando el mar está tranquilo. Lleva su "
          ...
          "delfines cerca de la tabla. Jenna se queda de pie, sin moverse, y "
          "sonríe. El amanecer es su momento favorito del día.",
    "en": "Jenna gets up very early, when the sea is calm. She carries her "
          ...
          "dolphins near the board. Jenna stays standing, without moving, and "
...
},
{
  ...
  "dialogue": [
    ...
    ("Jenna", "Hace mucho calor y hay mucha humedad.", "It's very hot and very humid."),
    ("Novio", "Por la tarde viene una tormenta, dicen.", "In the afternoon a storm is coming, they say."),
    ("Jenna", "Típico de Florida en verano.", "Typical of Florida in summer."),
  ...
  "story": {
    ...
    "es": "En verano, Florida es muy caliente y húmeda. Por la mañana hace sol y el "
          ...
          "el sol sale otra vez. Jenna dice que el clima de Florida es dramático "
          "pero nunca aburrido.",
    "en": "In summer, Florida is very hot and humid. In the morning it's sunny and "
          ...
          "Afterward, the sun comes out again. Jenna says Florida's weather is "
...
},
{
  ...
  "dialogue": [
    ("Jenna", "Mira, el hibisco tiene flores nuevas.", "Look, the hibiscus has new flowers."),
    ("Novio", "Son muy coloridas. ¿De qué color?", "They're very colorful. What color?"),
    ("Jenna", "Rojas y rosadas. La buganvilla también florece.", "Red and pink. The bougainvillea is blooming too."),
    ("Novio", "Las palmeras dan buena sombra.", "The palm trees give good shade."),
    ("Jenna", "Me encanta el aroma del jardín por la mañana.", "I love the scent of the garden in the morning."),
  ],
  "story": {
    "title": "El jardín tropical",
    "es": "El jardín de Jenna está lleno de plantas tropicales. Hay palmeras "
          ...
          "Jenna dice que su jardín es un pequeño paraíso.",
    "en": "Jenna's garden is full of tropical plants. There are tall palm trees "
          ...
          "scent of the flowers is sweet. The birds come to drink water. Jenna "
...
},
{
  ...
  "dialogue": [
    ("Jenna", "Voy a regar las plantas antes del calor.", "I'm going to water the plants before the heat."),
    ("Novio", "¿Necesitas los guantes y la pala?", "Do you need the gloves and the shovel?"),
    ("Jenna", "Sí, y voy a plantar unas semillas nuevas.", "Yes, and I'm going to plant some new seeds."),
    ("Novio", "La tierra está seca. Necesita agua.", "The soil is dry. It needs water."),
    ("Jenna", "También tengo que quitar la mala hierba.", "I also have to pull the weeds."),
  ],
  "story": {
    "title": "La rutina del jardín",
    "es": "Todas las mañanas, Jenna cuida su jardín. Primero riega las plantas con "
    ...
    "en": "Every morning, Jenna takes care of her garden. First she waters the "
...
{
  "icon": "🐶", "title": "Maggie (your dog)",
  "intro": "Maggie is family. Because she's a girl, her words are feminine — "
           "<span class='es'>la perra</span>, and <span class='es'>cariñosa</span> "
           "with an -a.",
  "vocab": [
    ("la perra", "the dog (female)", "Maggie is a girl → la perra"),
    ("cariñosa", "affectionate", "-a because Maggie is female"),
    ("la correa", "the leash", ""),
    ...
    ("¡Quieta!", "Stay!", "-a for Maggie"),
    ("dormir en el sofá", "to sleep on the couch", ""),
  ],
  "dialogue": [
    ("Jenna", "Voy a pasear a Maggie por la playa.", "I'm going to walk Maggie on the beach."),
    ("Joshua", "¿Llevas la correa?", "Are you taking the leash?"),
    ("Jenna", "Sí. ¡Ven aquí, Maggie! ¡Siéntate!", "Yes. Come here, Maggie! Sit!"),
    ("Joshua", "Esa perra es muy cariñosa.", "That dog is very affectionate."),
    ("Jenna", "Sí. Mueve la cola cuando me ve.", "Yes. She wags her tail when she sees me."),
  ],
  "story": {
    "title": "Maggie",
    "es": "Jenna tiene una perra que se llama Maggie. Es muy cariñosa y siempre "
          "duerme conmigo. Cada tarde, Jenna la pasea por la playa con su correa. "
          "A Maggie le gusta correr en la arena y jugar con las olas. Cuando llegan "
          "a casa, Maggie bebe mucha agua y duerme en el sofá. Por la noche, pone "
          "la cabeza en las piernas de Jenna. Es una buena chica y es parte de la "
          "familia.",
    "en": "Jenna has a dog named Maggie. She's very affectionate and always sleeps "
          "with me. Every afternoon, Jenna walks her on the beach with her leash. "
          "Maggie likes to run in the sand and play with the waves. When they get "
          "home, Maggie drinks a lot of water and sleeps on the couch. At night, "
          "she puts her head on Jenna's legs. She's a good girl and part of the "
          "family.",
  },
  "fill": [
    ("Voy a ___ a Maggie por la playa.", "pasear"),
    ("Llevo la ___ para caminar.", "correa"),
    ("Maggie es muy ___.", "cariñosa"),
    ("A Maggie le gusta ___ en la arena.", "correr"),
    ("¡___ aquí, Maggie! ¡Siéntate!", "Ven"),
  ],
  "translate": [
    ("I walk Maggie.", "Paseo a Maggie."),
    ("My dog is affectionate.", "Mi perra es cariñosa."),
    ("Come here!", "¡Ven aquí!"),
    ("She sleeps on the couch.", "Duerme en el sofá."),
  ],
},
{
  "icon": "🏋", "title": "The Gym",
  "intro": "Workout vocabulary — you exercise almost every day.",
  "vocab": [
    ("el gimnasio", "the gym", ""),
  ...
  "dialogue": [
    ...
    ("Jenna", "Sí, hoy quiero hacer pesas y yoga.", "Yes, today I want to do weights and yoga."),
    ("Novio", "Yo voy a correr en la cinta primero.", "I'm going to run on the treadmill first."),
    ("Jenna", "No olvides el calentamiento.", "Don't forget the warm-up."),
  ...
  "story": {
    ...
    "es": "Jenna y su novio van al gimnasio tres veces por semana. Ella hace yoga "
          ...
          "fuerte hoy”, dice él. Jenna se ríe y toma agua.",
    "en": "Jenna and her boyfriend go to the gym three times a week. She does "
          ...
          "today,” he says. Jenna laughs and drinks water.",
  },
  "fill": [
...
},
{
  ...
  "dialogue": [
    ...
    ("Jenna", "¿Esta? Tiene un ritmo muy pegadizo.", "This one? It has a very catchy rhythm."),
    ("Novio", "¡Perfecta! Vamos a bailar.", "Perfect! Let's dance."),
    ("Jenna", "No sé bailar salsa muy bien todavía.", "I don't know how to dance salsa very well yet."),
    ("Novio", "Yo te enseño. Sigue el ritmo.", "I'll teach you. Follow the rhythm."),
  ],
  "story": {
    "title": "Noche de salsa",
    "es": "Los sábados por la noche, el novio de Jenna pone música cubana en la "
          "casa. Sube el volumen y baila en la cocina. Las canciones tienen un ritmo "
          "rápido y una letra alegre. Jenna no sabe bailar salsa muy bien, pero "
          "él la enseña, paso a paso. Poco a poco, ella sigue el ritmo mejor. "
          "Al final de la noche, los dos ríen y bailan sin parar.",
    "en": "On Saturday nights, Jenna's boyfriend plays Cuban music in the house. "
          "He turns up the volume and dances in the kitchen. The songs have a fast "
          "rhythm and happy lyrics. Jenna doesn't know how to dance salsa very "
...
},
{
  ...
  "dialogue": [
    ...
    ("Jenna", "Yo también, mi amor. Nos vemos esta noche.", "Me too, my love. See you tonight."),
    ("Novio", "¿Quieres salir a cenar? Una cita.", "Do you want to go out to dinner? A date."),
    ("Jenna", "¡Me encanta la idea! Te quiero.", "I love the idea! I love you."),
    ("Novio", "Yo te quiero más. Un beso.", "I love you more. A kiss."),
  ],
  "story": {
    "title": "Nuestra historia",
    "es": "Jenna y su novio están juntos desde hace dos años. Se conocieron en "
          "una fiesta y hablaron toda la noche. Al principio, Jenna no hablaba "
          "español y él no hablaba mucho inglés, pero el amor no necesita muchas "
          "palabras. Ahora Jenna aprende español para hablar con él y con su "
          "familia cubana. Cada día están más enamorados. “Eres mi cariño”, "
          "le dice él.",
    "en": "Jenna and her boyfriend have been together for two years. They met at "
          "a party and talked all night. At first, Jenna didn't speak Spanish and "
          "he didn't speak much English, but love doesn't need many words. Now "
          "Jenna is learning Spanish to talk with him and with his Cuban family. "
...
},
{
  ...
  "dialogue": [
    ...
    ("Jenna", "¡Qué rico! ¿Necesitas ayuda?", "How delicious! Do you need help?"),
    ("Novio", "Sí, corta la cebolla y el ajo, por favor.", "Yes, cut the onion and garlic, please."),
    ("Jenna", "¿Y los plátanos? ¿Tostones o maduros?", "And the plantains? Tostones or sweet?"),
    ("Novio", "Tostones. Los frío en la sartén.", "Tostones. I'll fry them in the pan."),
  ],
  "story": {
    "title": "La cena cubana",
    "es": "El novio de Jenna cocina comida cubana los domingos. Hoy hace arroz "
          ...
          "arroz. La cocina huele delicioso. Jenna prueba los frijoles. "
          "“Están sabrosos”, dice. Comen juntos y escuchan música. Es su "
          "domingo perfecto.",
    "en": "Jenna's boyfriend cooks Cuban food on Sundays. Today he makes chicken "
          ...
          "The kitchen smells delicious. Jenna tastes the beans. “They're "
...
},
{
  ...
  "dialogue": [
    ("Jenna", "¿Tenemos la lista para el supermercado?", "Do we have the list for the supermarket?"),
    ("Novio", "Sí. Necesitamos leche, pan y frutas.", "Yes. We need milk, bread, and fruit."),
    ("Jenna", "¿Cuánto cuesta el mango?", "How much does the mango cost?"),
    ("Novio", "Está barato hoy. Compramos varios.", "It's cheap today. Let's buy several."),
    ("Jenna", "Perfecto. Pago yo en la caja.", "Perfect. I'll pay at the checkout."),
  ],
  "story": {
    "title": "En el mercado",
    "es": "Los sábados, Jenna y su novio van al mercado. Primero hacen una lista "
          "en casa. En el mercado hay mucha fruta fresca: mangos, piñas y plátanos. "
          "Las verduras están baratas y de buena calidad. Jenna pregunta el precio "
          "de todo. Compran comida para toda la semana y llenan dos bolsas. Al "
          "final, pagan en la caja y vuelven a casa contentos.",
    "en": "On Saturdays, Jenna and her boyfriend go to the market. First they "
          ...
          "Jenna asks the price of everything. They buy food for the whole week "
...
},
{
  ...
  "dialogue": [
    ("Jenna", "Voy a limpiar la cocina esta mañana.", "I'm going to clean the kitchen this morning."),
    ("Novio", "Yo ordeno la sala y saco la basura.", "I'll tidy the living room and take out the trash."),
    ("Jenna", "Después descansamos en el sofá.", "Then we'll rest on the couch."),
    ("Novio", "Abre la ventana, hace calor.", "Open the window, it's hot."),
    ("Jenna", "La casa está muy cómoda hoy.", "The house is very comfortable today."),
  ],
  "story": {
    "title": "Nuestra casa",
    "es": "La casa de Jenna es pequeña pero cómoda. Tiene dos cuartos, una cocina, "
          "un baño y una sala con un sofá grande. Afuera hay un jardín con palmeras. "
          "Por la mañana, Jenna abre las ventanas para sentir la brisa. Los "
          ...
          "favorito del mundo.",
    "en": "Jenna's house is small but comfortable. It has two bedrooms, a "
          "kitchen, a bathroom, and a living room with a big couch. Outside there's "
          "a garden with palm trees. In the morning, Jenna opens the windows to "
...
},
{
  ...
  "dialogue": [
    ...
    ("Jenna", "Sí, por favor. Con un poco de azúcar.", "Yes, please. With a little sugar."),
    ("Novio", "El café cubano es fuerte y dulce.", "Cuban coffee is strong and sweet."),
    ("Jenna", "Me gusta el café con leche por la mañana.", "I like coffee with milk in the morning."),
    ("Novio", "Ya está listo. Está bien caliente.", "It's ready. It's nice and hot."),
  ],
  "story": {
    "title": "El cafecito de la mañana",
    "es": "En la casa de Jenna, la mañana empieza con café. Su novio prepara un "
          "cafecito cubano en la cafetera. El café es pequeño, fuerte y muy dulce, "
          "con mucha azúcar. Jenna prefiere un café con leche, más suave. Beben el "
    ...
    "en": "In Jenna's house, the morning begins with coffee. Her boyfriend makes "
          "a Cuban cafecito in the moka pot. The coffee is small, strong, and very "
          "sweet, with a lot of sugar. Jenna prefers a coffee with milk, milder. "
...
},
{
  ...
  "dialogue": [
    ...
    ("Jenna", "A las nueve. Tengo una reunión temprano.", "At nine. I have an early meeting."),
    ("Novio", "¿Estás muy ocupada hoy?", "Are you very busy today?"),
    ("Jenna", "Sí, tengo mucho trabajo y muchos correos.", "Yes, I have a lot of work and a lot of emails."),
    ("Novio", "Descansa un poco. Nos vemos esta tarde.", "Rest a little. See you this afternoon."),
  ],
  "story": {
    "title": "Un día de trabajo",
    "es": "Jenna trabaja en una oficina cerca de la playa. Empieza a las nueve y "
          ...
          "playa a descansar.",
    "en": "Jenna works in an office near the beach. She starts at nine and "
...
},
{
  ...
  "dialogue": [
    ...
    ("Jenna", "Nada, en la playa. ¿Y tú?", "Nothing, at the beach. And you?"),
    ("Novio", "En el gym. Nos vemos luego?", "At the gym. See you later?"),
    ("Jenna", "Claro! A las 6 en casa. Tqm", "Of course! At 6 at home. Love you lots."),
    ("Novio", "Dale, bn. Un beso 😘", "Okay, cool. A kiss."),
  ],
  "story": {
    "title": "Mensajes de un día",
    "es": "Jenna y su novio se escriben todo el día. Por la mañana, él le manda "
          ...
          "mismo: “Nos vemos, tqm”.",
    "en": "Jenna and her boyfriend text all day. In the morning, he sends her a "
